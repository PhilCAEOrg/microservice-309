...
import i5.las2peer.services.testRes.database.DatabaseManager;
import java.sql.*;
...
@ServicePath("testres")
@ManualDeployment
public class TestRes extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "309", version = "$Metadata_Version$",
          description = "$Metadata_Description$",
          termsOfService = "$Metadata_Terms$",
          contact = @Contact(name = "Philipp", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/PhilCAEOrg/microservice-309/blob/master/LICENSE.txt") ) )
  @Path("/")
  public static class RootResource {

    private final TestRes service = (TestRes) Context.getCurrent().getService();
